...
VALUES
  ('https://www.codecademy.com/', 'Learn to code here!', 'I thought this site was really helpful and just wanted to share!!!', 1, 1);
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
...
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
  ('https://launchschool.com/books/command_line/read/introduction#briefoverview', 'Wooooooooow!', 'Who knew the command line was so complicated?!?', 3, 1);
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
...
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
  ('http://jlord.us/git-it/index.html', 'Git it? Got it! Good!', 'For anyone looking to become a git-head', 4, 1);
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
...
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
  ('https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Loops_and_iteration', 'Im feeling a bit loopy', 'This should help you get started on learning to loop', 5, 1);
INSERT INTO resources
  (url, title, description, user_id, category_id)
VALUES
